            ...
            <div class="card-title mb-4">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <span class="text-black-50">Melihat Aktivitas Barang</span>
                    </div>
                    <div class="col-md-6 d-flex justify-content-end">
                        ...
                        <button class="btn btn-success ms-3 btn-print" title="Print"><i class="fa-solid fa-file-pdf"></i> &nbsp; Print</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btn-print').click(function() {
                window.location.href = `{{ route('r-barang.printToPdf') }}?startdate=${startDate}&enddate=${endDate}&tipe=${tipeData}`;
            });
        });
    </script>
@endpush